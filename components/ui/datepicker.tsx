  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: 'top-1/2 -translate-y-1/2 left-1.5 rtl:left-auto rtl:right-1.5',
        nav_button_next: 'top-1/2 -translate-y-1/2 right-1.5 rtl:right-auto rtl:left-1.5',
        ...
        cell: cn(
          ...
          'rtl:first:[&:has([aria-selected])]:rounded-r-lg rtl:last:[&:has([aria-selected])]:rounded-l-lg',
          // first range el
          '[&:not(:has(button))+:has(.day-range-middle)]:rounded-l-lg',
          'rtl:[&:not(:has(button))+:has(.day-range-middle)]:rounded-r-lg',
          // last range el
          '[&:not(:has(+_*_button))]:rounded-r-lg',
          'rtl:[&:not(:has(+_*_button))]:rounded-l-lg',
          ...
          'rtl:before:-left-2 rtl:before:right-auto',
          ...
          'rtl:[&:has(.day-range-end)]:before:right-0 rtl:[&:has(.day-range-end)]:before:left-auto',
        ),
        day: cn(
          // base
